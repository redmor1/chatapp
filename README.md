...
| **Conversaciones.API** | `http://localhost:5217` | `https://localhost:7189` |
...
dotnet run --project Conversaciones.API/Conversaciones.API.csproj --launch-profile http
...
| `conversaciones-api` | `5217` | `8080` | `http://localhost:5217` | `http://conversaciones-api:8080` |
